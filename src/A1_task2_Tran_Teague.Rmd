...
Figure 1. Mean annual temperature, tree canopy cover, cloudiness, and cropland cover of different countries (each point represents a country) are plotted. Approximately 77% (PC1 = 42.91% and PC2 = 34.82%) of the variance in the data is captured in this biplot. 
### Summary:
